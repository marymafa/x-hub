const chats = (app, client) => {
    app.post("/send/message", async (req, res) => {
        ...
        var allUsers = await client.query(`INSERT INTO chats(messages, sender_id, receiver_id) VALUES ($1, $2, $3);`, [req.body.message, senderInfo.rows[0].id, receiverInfo.rows[0].id]);
        res.status(201).end();
    })
